...
func Install() {
	...
	skipClassification = clogCmd.Bool("skip", false, "if enabled will skip trying to classify and just give a list of changes")
	addPromotional = clogCmd.Bool("promo", false, "if enabled will add a \"generated by\" promotional tag to the changelog ")
}
...
func Run(args []string) {
	...
	changelog, clogErr := clog.CommitLog(currentRepository, *startCommit, *endCommit, *inclusionFlags, *skipClassification, *addPromotional)
